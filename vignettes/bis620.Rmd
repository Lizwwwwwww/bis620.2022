...
db2[["B_HEIGHT"]] <- as.numeric(db2[["B_HEIGHT"]] <
                                  median(db2[["B_HEIGHT"]], na.rm = TRUE))
db2[["B_WEIGHT"]] <- as.numeric(db2[["B_WEIGHT"]] <
                                  median(db2[["B_WEIGHT"]], na.rm = TRUE))
```
