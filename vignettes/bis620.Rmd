...
```{r}
dat <- data.frame(dl$adsl$SUBJID, dl$adsl$ATRT,
                  dl$adsl$PRSURG, dl$adsl$DTHDY, dl$adsl$DTH,
                  dl$adsl$LIVERMET, dl$adsl$AGE, dl$adsl$SEX,
                  dl$adsl$B_WEIGHT, dl$adsl$B_HEIGHT,
